package pl.muybien.marketsync.asset.crypto.tether;
...
public class TetherService implements AssetService {
    ...
    public void fetchCurrentAsset() {
        var cryptoPrice = cryptoProvider.fetchAsset("tether").getPriceUsd();
