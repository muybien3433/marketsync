package pl.muybien.marketsync.asset.crypto.ethereum;
...
public class EthereumService implements AssetService {
    ...
    public void fetchCurrentStock() {
        var cryptoPrice = cryptoProvider.fetchAsset("ethereum").getPriceUsd();
