package pl.muybien.marketsync.asset.crypto.tron;
...
public class TronService implements AssetService {
    ...
    public void fetchCurrentAsset() {
        var cryptoPrice = cryptoProvider.fetchAsset("tron").getPriceUsd();
