package pl.muybien.marketsync.asset.crypto.dogecoin;
...
public class DogecoinService implements AssetService {
    ...
    public void fetchCurrentStock() {
        var cryptoPrice = cryptoProvider.fetchAsset("dogecoin").getPriceUsd();
