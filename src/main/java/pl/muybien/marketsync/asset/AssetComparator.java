...
public class AssetComparator {
    ...
    @Transactional
    public <T extends AssetTarget> boolean currentPriceMetSubscriptionCondition(BigDecimal currentPriceUsd, T subscription) {
    ...
    private <T extends AssetTarget> void sendNotification(T subscription,
