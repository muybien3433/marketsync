package pl.muybien.marketsync.currency.crypto.usdcoin;
...
public class UsdcService implements CryptoService {
    ...
    public void fetchCurrentStock() {
        var cryptoPrice = cryptoCurrencyProvider.fetchCurrencyByUri("usd-coin").getPriceUsd();
