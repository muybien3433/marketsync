...
import pl.muybien.subscriptionservice.finance.crypto.ethereum.EthereumResponse;
...
public class SolanaService implements FinanceService {
    ...
    public void fetchCurrentFinanceAndCompare() {
        ...
        SolanaResponse response = webClient.get().retrieve().bodyToMono(SolanaResponse.class).block();
