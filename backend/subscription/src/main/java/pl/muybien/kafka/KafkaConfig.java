...
public class KafkaConfig {
    ...
    @Bean
    public ProducerFactory<String, SubscriptionConfirmation> subscriptionProducerFactory() {
    ...
    public KafkaTemplate<String, SubscriptionConfirmation> subscriptionKafkaTemplate(
            ProducerFactory<String, SubscriptionConfirmation> subscriptionProducerFactory) {
