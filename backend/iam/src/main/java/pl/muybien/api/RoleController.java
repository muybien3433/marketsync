...
public class RoleController {
    ...
    public ResponseEntity<Void> renameAuthority(
            ...
            @Valid @RequestBody AuthorityRoleRenameRequest request
    ) {
    ...
    public ResponseEntity<Void> createCompositeRole(
            @Valid @RequestBody CompositeRoleCreateRequest request
    ) {
    ...
    public ResponseEntity<Void> updateCompositeRole(
            ...
            @Valid @RequestBody CompositeRoleUpdateRequest request
    ) {
